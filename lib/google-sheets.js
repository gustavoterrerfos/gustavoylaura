...
async function getGifts() {
  try {
    ...
    console.log('Instancia de Google Sheets obtenida');
    ...
    console.log('Metadatos de la hoja:', sheetMetadata.data);
    ...
    if (!rows || rows.length < 2) {
      console.error('No se encontraron suficientes filas en la hoja');
